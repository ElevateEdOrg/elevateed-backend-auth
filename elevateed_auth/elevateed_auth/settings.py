...
DATABASES = {
    'default': {
        ...
        'NAME': 'Elevatedb',  # database name
        'USER': 'postgres',  # PostgreSQL username
        'PASSWORD': '300282',  # PostgreSQL password
        'HOST': '192.168.10.49',  # PostgreSQL host
...
EMAIL_HOST_USER = 'thisisyashs@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'otftfcwctjzbnmam'  # Your Gmail password or app-specific password
DEFAULT_FROM_EMAIL = 'thisisyashs@gmail.com'
